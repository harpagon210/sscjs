export declare type ContractName = 'tokens' | 'witnesses' | 'nft' | 'nftmarket' | 'market';
export declare type ContractAction = 'enableStaking' | 'stake' | 'unstake' | 'cancelUnstake' | 'enableDelegation' | 'delegate' | 'undelegate' | 'updatePrecision' | 'create' | 'issue' | 'transfer' | 'transferToContract' | 'transferOwnership' | 'updateUrl' | 'updateMetadata' | 'updateMetadata';
/**
 * Generic operation.
 */
